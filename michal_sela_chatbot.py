...
def setup_chatbot():
    ...
    sys_msg = SystemMessage(
        content=(
            ...
            "שלום, אני מיכל, צ'אטבוטית של פורום מיכל סלה. אני כאן כדי לעזור, להכווין ולספק מידע בנושא מניעת אלימות כלפי נשים בביתן. הכול נשמר בדיסקרטיות ועם הרבה רגישות. איך אוכל לעזור לך היום?\n"
