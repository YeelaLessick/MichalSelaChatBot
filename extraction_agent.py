...
3. לגבי "מין הפונה": קבעי את המין רק לפי סימנים דקדוקיים מפורשים בעברית של הפונה עצמה — במיוחד צורות פועל, שמות תואר וכינויים בגוף ראשון המתייחסים לעצמה (למשל "אני מרגישה"/"פוחדת"/"בעלי" → נקבה; "אני מרגיש"/"פוחד"/"אשתי" → זכר).
   אם אין בשיחה מילה שמסגירה במפורש את המין של הפונה, החזירי "לא ידוע". אל תסיקי מין מהנושא, מההקשר, או מהנחות כלליות.
